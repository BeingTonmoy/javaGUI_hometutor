...
public class TeacherAdd extends JFrame {
    ...
    TeacherAdd() {
        ...
        this.setTitle("HomeTutor - Admin Teacher Add");
        ...
        String[] secQsn = { "Select Degree / University", "MSc", "BSc",
                "DU Studnet", "BUET Student", "Medical Student" };
        ...
        btn2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                if (textField1.isEmpty() || textField2.isEmpty() || textField3.isEmpty() || textField4.isEmpty()
                    ...
                    try {
                        File file = new File(".\\Data\\teacher_data.txt");
                        if (!file.exists()) {
                            file.createNewFile();
                        }
                        ...
                        pw.println("Degree/University : " + secQsn);
                    ...
                    JOptionPane.showMessageDialog(null, "Teacher has been added.", "Teacher Added",
