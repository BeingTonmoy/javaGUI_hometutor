...
public class TeacherInfo extends JFrame {
    ...
    private String[] column = { "Teacher Name", "Password", "Email", "Degree/University", "Phone", "Date and Time" };
    private String[] rows = new String[7];

    TeacherInfo() {
        // Frame Layout
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setTitle("HomeTutor Admin Panel - Teacher Info");
        ...
        try {
            ...
            for (int i = 0; i < totalLines; i++) {
                ...
                if (x.equals("User")) {
                    ...
                    rows[3] = Files.readAllLines(Paths.get(file)).get((i + 3)).substring(20); // Degree
        ...
        btn2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                if (table.getSelectionModel().isSelectionEmpty()) {
                    JOptionPane.showMessageDialog(null, "Please select a Teacher to delete", "No teacher selected!",
                    ...
                    try {
                        ...
                        for (int j = 0; j < totalLines; j++) {
                            ...
                            if (q != 0 && (j == q || j == (q + 1) || j == (q + 2) || j == (q + 3) || j == (q + 4) || j == (q + 5))) {
                                ...
                                pw.println("Teacher Removed! " + userName);
                            } else {
                                String userName = Files.readAllLines(Paths.get(file)).get(j);
                                pw.println(userName);
                            }
